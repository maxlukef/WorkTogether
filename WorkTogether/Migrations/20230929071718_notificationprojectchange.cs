...
{
    /// <inheritdoc />
    public partial class notificationprojectchange : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachedProject = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_AspNetUsers_ProfessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TAClasses", x => x.ID);
                    table.ForeignKey(
                        name: "FK_TAClasses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TAClasses_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    AnswerStr = table.Column<string>(type: "longtext", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    AnswererId = table.Column<string>(type: "varchar(255)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskItemUser", x => new { x.AssigneesId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_TaskItemUser_AspNetUsers_AssigneesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TAClasses_ClassId",
                table: "TAClasses",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_TAClasses_UserId",
                table: "TAClasses",
                column: "UserId");
