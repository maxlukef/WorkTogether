...
class ProjectEditPage extends StatefulWidget {
  ProjectEditPage({required this.projectId, required this.classId, Key? key})
      : super(key: key);
...
class _projectEditPageState extends State<ProjectEditPage> {
      ...
      body: SingleChildScrollView(
        ...
        Padding(
            padding: EdgeInsets.only(
                left: screenPadding / 2, right: screenPadding / 2),
            child: Column(children: [
              const Align(
                  alignment: Alignment.centerLeft,
                  child: Text("Move Students",
                      style: TextStyle(
              ...
              Align(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    moveStudent(studentDropdownValue, oldGroupDropdownValue,
                        newGroupDropdownValue);
                  },
                  child: const Text(
                    'Move',
              ...
              Row(children: [
                FutureBuilder(
                  ...
                  builder:
                    ...
                    if (snapshot.hasData) {
                      widget.inviteCode = snapshot.data!
                          .substring(1, snapshot.data!.length - 1);
  ...
  Future<List<String>> getStudentsInProject(int id) async {
    List<User>? students =
        await HttpService().getStudentsInClass(widget.classId);
